    ...
    */
    ApiService.prototype.update = function (url, action, dataObject) {
        ...
        if (action == "template") {
            ...
            return this.http.post(url + "/" + action + "/" + dataObject._id, { color: dataObject.color }, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
        }
        else if (action == "bookcolor") {
            return this.http.post(url + "/" + action + "/" + dataObject._id, { color: dataObject.color, isbn13: dataObject.isbn13 }, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
        }
        else {
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(_snackBar, api, dialog) {
        ...
        this.filterText = "";
        this.statistics = {};
        this.publisherColors = ["white", "green", "red", "orange", "yellow"];
        this.publisherColorsOpacity = ["rgba(255, 255, 255, 0.2)", "rgba(0, 255, 0, 0.2)", "rgba(255, 0, 0, 0.2)", "rgba(255, 165, 0, 0.2)", "rgba(255, 255, 0, 0.2)"];
        this.host = "http://192.168.178.44:4201"; //"http://192.168.178.91:4201"
    ...
    ProductListComponent.prototype.openDialogTimeout = function (book, mail, event, note) {
        var _this = this;
        if (event) {
        ...
        setTimeout(function () {
            _this.openDialog(book, mail, note);
        }, 100);
    };
    ProductListComponent.prototype.openDialog = function (book, mail, note) {
        var _this = this;
        var dialogRef = this.dialog.open(SendMailDialog, {
    ...
    ProductListComponent.prototype.sortMails = function (a, b) {
        if (a.note && !b.note) {
            return -1;
        }
    ...
    ProductListComponent.prototype.preparePublisherList = function (publishers, statistics) {
        ...
        publishers.forEach(function (publisher) {
            ...
            var foundISBN13 = {};
            publisher.books = publisher.books.filter(function (book) {
    ...
    ProductListComponent.prototype.changePublisherColor = function () {
        ...
        this.api.update(this.updateurl, "publishercolor", this.selectedPublisher).subscribe(function (data) { }, function (err) { });
    };
    ProductListComponent.prototype.changeBookColor = function (book) {
        if (!book.color) {
            book.color = 1;
        }
        else {
        ...
        this.api.update(this.updateurl, "bookcolor", { _id: this.selectedPublisher._id, color: book.color, isbn13: book.isbn13 }).subscribe(function (data) { }, function (err) { });
    };
